                ...
                <div class="add-new-company-from-wrap">
                    ...
                    <form action="" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" placeholder="Enter Email" value="{{ old('email')}}" name="email" id="email">
                            @error('email') <span>{{ $message }}</span> @enderror
                        </div>

                        <div class="form-group">
                            <label for="kvk_number">kvk number <span>*</span></label>
                            <input type="text" class="form-control" placeholder="Enter kvk number Number" value="{{ old('kvk_number')}}" name="kvk_number" id="kvk_number">
