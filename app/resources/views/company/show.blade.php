          ...
          <div class="media align-items-start">
            ...
            <div class="media-body">
              ...
              <ul>
                ...
                <li><img src="{{ asset('assets/images/icons/call.svg') }}" alt="I" class="img-fluid"> <span>{{ $company->phone }}</span></li>
                <li><img src="{{ asset('assets/images/icons/gps.svg') }}" alt="I" class="img-fluid"> <span>{{ $company->location }}</span></li>
              </ul>
