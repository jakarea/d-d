        ...
        <ul>
            <li>
                <a href="{{url('/dashboard')}}" class="{{ Request::is('dashboard') ? 'active' : ''}}">
                    <img src="{{ asset('assets/images/icons/dashboard.svg') }}" alt="I" class="img-fluid">
                    Dashboard
                </a>
            </li>
            <li>
                <a href="{{url('/marketplace')}}" class="{{ Request::is('marketplace*') ? 'active' : ''}}">
                    <img src="{{ asset('assets/images/icons/marketplace.svg') }}" alt="I" class="img-fluid">
                    Marketplace
                </a>
            </li>
            <li>
                <a href="{{url('/company')}}" class="{{ Request::is('company*') ? 'active' : ''}}">
                    <img src="{{ asset('assets/images/icons/company.svg') }}" alt="I" class="img-fluid">
                    Company
                </a>
            </li>
            <li>
            ...
            <li>
                <a href="{{url('/analytics')}}" class="{{ Request::is('analytics*') ? 'active' : ''}}">
                    <img src="{{ asset('assets/images/icons/analytics.svg') }}" alt="I" class="img-fluid"> 
                    Analytics
                </a>
            </li>
            <li>
                <a href="{{url('/earning')}}" class="{{ Request::is('earning*') ? 'active' : ''}}">
                    <img src="{{ asset('assets/images/icons/earnings.svg') }}" alt="I" class="img-fluid">
                     Earning
                </a>
            </li>
            <li>
                <a href="{{url('/packages')}}" class="{{ Request::is('packages*') ? 'active' : ''}}">
                    <img src="{{ asset('assets/images/icons/fee.svg') }}" alt="I" class="img-fluid"> 
                    Monthly &amp; Yearly Fee
                </a>
            </li>
            <li>
                <a href="{{url('/advertisement')}}" class="{{ Request::is('advertisement*') ? 'active' : ''}}">
                    <img src="{{ asset('assets/images/icons/advertisment.svg') }}" alt="I" class="img-fluid"> 
                    Advertisement
                </a>
            </li>
            <li>
