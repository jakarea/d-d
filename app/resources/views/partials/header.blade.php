        ...
        <ul class="main">
            ...
            <li>
                <div class="dropdown p-0 header-dropdown">
                    <a class="p-0" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <a class="dropdown-item {{ Request::is('account/my-profile') ? 'active' : ''}}" href="{{url('account/my-profile')}}">Profile 
                        ...
                        <li>
                            <a class="dropdown-item  {{ Request::is('account/edit-profile') ? 'active' : ''}}" href="{{url('account/edit-profile')}}">
                                Profile Setting 
